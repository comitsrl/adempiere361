...
public class X_A_Depreciation_Exp extends PO implements I_A_Depreciation_Exp, I_Persistent 
{
	 ...
	 *
	 */
	private static final long serialVersionUID = 20110526L;
...
// 0
    ...
    {
		return (I_A_Asset_Addition)MTable.get(getCtx(), I_A_Asset_Addition.Table_Name)
    ...
    {
		return (I_A_Asset_Disposed)MTable.get(getCtx(), I_A_Asset_Disposed.Table_Name)
    ...
    {
		return (I_A_Depreciation_Entry)MTable.get(getCtx(), I_A_Depreciation_Entry.Table_Name)
