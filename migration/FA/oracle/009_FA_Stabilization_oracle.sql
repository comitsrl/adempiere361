...
UPDATE AD_Column SET IsIdentifier='N',Updated=TO_DATE('2012-03-09 14:43:25','YYYY-MM-DD HH24:MI:SS'),UpdatedBy=100 WHERE AD_Column_ID=59259
;

-- Mar 9, 2012 2:43:31 PM WIT
-- Complete Fixed Assets
ALTER TABLE A_Asset MODIFY A_Asset_Type_ID NUMBER(10) DEFAULT NULL 
;

-- Mar 9, 2012 2:43:31 PM WIT
-- Complete Fixed Assets
ALTER TABLE A_Asset MODIFY A_Asset_Type_ID NULL
;

-- Mar 9, 2012 2:57:06 PM WIT
-- Complete Fixed Assets
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,SeqNo,Help,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsSyncDatabase,IsKey,AD_Element_ID,IsAutocomplete,IsAllowLogging,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Description,Name,ColumnName,IsAllowCopy,CreatedBy,Updated,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (200075,53127,'U',0,'N','N','N',0,'The Invoice Document.','N',10,'N',30,'N','N',1008,'N','Y','N','Y','N','Invoice Identifier','Invoice','C_Invoice_ID','Y',100,TO_DATE('2012-03-09 14:56:58','YYYY-MM-DD HH24:MI:SS'),0,0,'Y',TO_DATE('2012-03-09 14:56:58','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- Complete Fixed Assets
ALTER TABLE A_Asset_Disposed ADD C_Invoice_ID NUMBER(10) DEFAULT NULL 
;

-- Mar 9, 2012 2:58:06 PM WIT
-- Complete Fixed Assets
INSERT INTO AD_Column (AD_Column_ID,AD_Table_ID,EntityType,Version,IsMandatory,IsTranslated,IsIdentifier,SeqNo,Help,IsParent,FieldLength,IsSelectionColumn,AD_Reference_ID,IsSyncDatabase,IsKey,AD_Element_ID,IsAutocomplete,IsAllowLogging,IsEncrypted,IsUpdateable,IsAlwaysUpdateable,Description,Name,ColumnName,IsAllowCopy,CreatedBy,Updated,AD_Client_ID,AD_Org_ID,IsActive,Created,UpdatedBy) VALUES (200076,53127,'U',0,'N','N','N',0,'The Invoice Line uniquely identifies a single line of an Invoice.','N',10,'N',30,'N','N',1076,'N','Y','N','Y','N','Invoice Detail Line','Invoice Line','C_InvoiceLine_ID','Y',100,TO_DATE('2012-03-09 14:58:04','YYYY-MM-DD HH24:MI:SS'),0,0,'Y',TO_DATE('2012-03-09 14:58:04','YYYY-MM-DD HH24:MI:SS'),100)
;
...
-- Complete Fixed Assets
ALTER TABLE A_Asset_Disposed ADD C_InvoiceLine_ID NUMBER(10) DEFAULT NULL 
;
